...
async def startup_event():
    ...
    logger.info("[scheduler] hydro forecast refresh scheduled every 60 minutes")
    logger.info("[scheduler] blackout refresh scheduled every 30 minutes")
...
async def get_weather():
    ...
    try:
        ...
        logger.warning("[weather] failed to persist weather snapshot: %s", exc)
